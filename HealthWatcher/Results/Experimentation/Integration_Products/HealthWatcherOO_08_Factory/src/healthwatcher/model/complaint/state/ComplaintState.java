...
public abstract int getStatus();public abstract void setObservation(String obs, Complaint complaint);public abstract void setAttendant(Employee atendente, Complaint complaint);public abstract void setComplainerAddress(Address end);public abstract void setCode(int cod);public String getEmail()
    { 
return this.email;
} 
...
public abstract void setComplainer(String solicitante);public ComplaintState(int codigo,String solicitante, String descricao,
