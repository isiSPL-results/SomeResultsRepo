...
public abstract void setEnderecoLocalOcorrencia(Address newEnderecoLocalOcorrencia);public AnimalComplaintState()
    {
}public String getTipoAnimal()
    { 
return this.animal;
} 
public abstract void setAnimal(String newAnimal);public Address getEnderecoLocalOcorrencia()
    { 
...
public abstract void setDataIncomodo(Date newDataIncomodo);public void setStatus(int sit,AnimalComplaint complaint)
    { 
...
public abstract void setQtdeAnimais(short newQtdeAnimais);public AnimalComplaintState(short qtdeAnimais, Date dataIncomodo, String animal, Address endereco)
    { 
