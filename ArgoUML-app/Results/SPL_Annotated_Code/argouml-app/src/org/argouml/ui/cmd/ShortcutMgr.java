...
//#if ( DEPLOYMENT  &&  SEQUENCE  &&  USECASE  &&  STATE  &&  COLLABORATION  &&  COGNITIVE  &&  ACTIVITY ) 
static
    {
        // First of all, let's set up the duplicate hash. This hash contains
        // all the duplicate key for another key.
...
//#if ( DEPLOYMENT  &&  SEQUENCE  &&  STATE  &&  LOGGING  &&  COLLABORATION  &&  COGNITIVE  &&  ACTIVITY ) && ! USECASE  
static
    {
        // First of all, let's set up the duplicate hash. This hash contains
        // all the duplicate key for another key.
...
//#if ( SEQUENCE  &&  USECASE  &&  STATE  &&  LOGGING  &&  COLLABORATION  &&  COGNITIVE  &&  ACTIVITY ) && ! DEPLOYMENT  
static
    {
        // First of all, let's set up the duplicate hash. This hash contains
        // all the duplicate key for another key.
