...
protected abstract void setProperty(String text);protected void setEventName(String en)
    { 
eventName = en;
} 
...
protected abstract String getProperty();public void targetSet(TargetEvent e)
    { 
setTarget(e.getNewTarget());
} 
