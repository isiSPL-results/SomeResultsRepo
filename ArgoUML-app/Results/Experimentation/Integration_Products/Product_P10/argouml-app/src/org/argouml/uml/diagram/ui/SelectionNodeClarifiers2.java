...
protected abstract String getInstructions(int index);private Object createEdge(MutableGraphModel gm, Object newNode, int index)
    { 
Object edge;
...
protected abstract Object getNewEdgeType(int index);@Override
...
protected abstract Icon[] getIcons();public final void paintButtons(Graphics g)
    { 
final Mode topMode = Globals.curEditor().getModeManager().top();
if(!(topMode instanceof ModePlace))//1
{ 
...
protected abstract Object getNewNodeType(int index);protected Object createEdgeAbove(MutableGraphModel gm, Object newNode)
    { 
