...
protected abstract boolean isValidElement(Object element);public void targetAdded(TargetEvent e)
    { 
...
protected abstract void buildModelList();public boolean isReverseDropConnection()
    { 
