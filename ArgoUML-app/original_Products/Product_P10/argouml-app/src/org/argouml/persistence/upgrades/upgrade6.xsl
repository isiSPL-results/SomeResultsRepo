...
<xsl:for-each select='/uml/argo/member[./@type = "profile"]'>
                     ...
                     copy-of select="@*"/>
                                    ...
                                    for-each>
                                    <xsl:
                                        for-each select='/uml/argo/member[./@type = "xmi"]'>
                                                    <member>
                                            <xsl:
                                                    copy-of select="@*"/>
                                                            </member>
                                                            ...
                                                            for-each>
                                                    <xsl:
                                                                for-each select='/uml/argo/member[./@type = "pgml"]'>
                                                                            <member>
                                                            <xsl:
                                                                            copy-of select="@*"/>
                                                                                    </member>
                                                                                    ...
                                                                                    for-each>
                                                                    <xsl:
                                                                                        for-each select='/uml/argo/member[./@type = "todo"]'>
                                                                                                    <member>
                                                                            <xsl:
                                                                                                    copy-of select="@*"/>
                                                                                                            </member>
                                                                                    ...
                                                                                    <xsl:
                                                                                                                for-each select='/uml/argo/member[./@type = "profile" and ./@type = "xmi" and ./@type = "pgml" and ./@type = "todo"]'>
                                                                                                                            <member>
                                                                                            <xsl:
                                                                                                                            copy-of select="@*"/>
                                                                                                                                    </member>
...
<private>
<xsl:
value-of select="substring-before(.,'sourcePortFig=&quot;tee_')" />
                </private>
                </xsl:
                template>
