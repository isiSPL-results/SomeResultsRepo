...
<Behavioral_Elements.Activity_Graphs.ActionState xmi.id="{@xmi.id}" xmi.uuid="{@xmi.uuid}">
        ...
        <xsl:
        copy-of select='./*[name() != "Foundation.Core.ModelElement.name"]'/>
                               ...
                               <Foundation.Core.ModelElement.isSpecification xmi.value="false"/>
                                       <Behavioral_Elements.Common_Behavior.Action.isAsynchronous xmi.value="false"/>
                                               ...
                                               <Foundation.Data_Types.ActionExpression xmi.id="update3.1_id3_{generate-id()}">
                                                       ...
                                                       <Foundation.Data_Types.Expression.body><xsl:
                                                       value-of select="Foundation.Core.ModelElement.name" /></Foundation.Data_Types.Expression.body>
...
<xsl:
template match='Behavioral_Elements.Activity_Graphs.ActivityGraph/Behavioral_Elements.State_Machines.StateMachine.top/Behavioral_Elements.State_Machines.CompositeState/Behavioral_Elements.State_Machines.CompositeState.subvertex/Behavioral_Elements.Activity_Graphs.ActionState/*' />
